package net.yustinus.crud.web.report;
...
public class ArialTemplate {
	...
	public static final StyleBuilder noPaddingStyle;
	...
	static {
		rootStyle           = stl.style().setPadding(2).setFontName("Arial").setFontSize(11);
		...
		titleStyle			= stl.style(rootStyle).setSpacingAfter(12).setSpacingBefore(6).setHorizontalTextAlignment(HorizontalTextAlignment.CENTER).setBorder(stl.border());
		noPaddingStyle		= stl.style(rootStyle).setPadding(0);
