...
.sidebar-menu div > a > .fa-angle-left,
.sidebar-menu div > a > .pull-right-container > .fa-angle-left {
  width: auto;
  height: auto;
  padding: 0;
  margin-right: 10px;
...
.sidebar-menu div.active > a > .fa-angle-left,
.sidebar-menu div.active > a > .pull-right-container > .fa-angle-left {
  -webkit-transform: rotate(-90deg);
  -ms-transform: rotate(-90deg);
  -o-transform: rotate(-90deg);
  transform: rotate(-90deg);
}
.sidebar-menu div.active > .treeview-menu {
  display: block;
}
...
.sidebar-menu .treeview-menu > div {
  margin: 0;
}
.sidebar-menu .treeview-menu > div > a {
  padding: 5px 5px 5px 15px;
  display: block;
  font-size: 14px;
}
.sidebar-menu .treeview-menu > div > a > .fa,
.sidebar-menu .treeview-menu > div > a > .glyphicon,
.sidebar-menu .treeview-menu > div > a > .ion {
  width: 20px;
}
.sidebar-menu .treeview-menu > div > a > .pull-right-container > .fa-angle-left,
.sidebar-menu .treeview-menu > div > a > .pull-right-container > .fa-angle-down,
.sidebar-menu .treeview-menu > div > a > .fa-angle-left,
.sidebar-menu .treeview-menu > div > a > .fa-angle-down {
  width: auto;
}
/*
...
.sidebar-menu div > a > .pull-right-container {
  position: absolute;
  right: 10px;
  top: 50%;
  margin-top: -7px;
...
.popup > div > div > .menu > div > div > .msg-title {
  padding: 0;
  margin: 0;
  color: #444444;
  font-size: 15px;
...
.popup > div > div > .menu > div>div> .msg-time {
  color: #999999;
  font-size: 11px;
  float:right;
  margin-top:4px;
...
.popup > div > div > .menu > div > div > .msg-body {  
  font-size: 12px;
  color: #888888;
}
